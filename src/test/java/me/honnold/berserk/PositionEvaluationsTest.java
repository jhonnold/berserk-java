...
class PositionEvaluationsTest {
    ...
    //        Position p = new Position("rnbqkbnr/pp3ppp/3p4/4p3/4P3/2N2N2/PP3PPP/R1BQKB1R b KQkq -
    // 0 6");
    //
    ...
    //        Position p = new Position("rnbqkbnr/pppppppp/8/8/8/P7/PPPPPPPP/RNBQKBNR w KQkq - 0
    // 1");
    //
    ...
    //        Position p = new Position("rnbqkbnr/pppppppp/8/8/3P4/1PN5/P1P1PPPP/R1BQKBNR w KQkq - 0
    // 1");
    //
    ...
    //        Position p = new Position("rnbqkbnr/pppppppp/8/8/3PP3/1PN5/P1P2PPP/R1BQKBNR w KQkq - 0
    // 1");
    //
    ...
    //        Position p =
    //                new Position("rnbqkbnr/pp4pp/5p2/4p3/3p2P1/NP2pP1N/P1PPP2P/R1BQKB1R w KQkq - 0
    // 1");
    //
    ...
    //        Position p =
    //                new Position("r1bqkbnr/ppp1pppp/2n5/3p4/3P4/2P2N2/PP2PPPP/RNBQKB1R b KQkq - 0
    // 3");
    //
