...
class PerftTest {
    ...
    void perft_bugfinder1() {
        long result =
                Perft.runPerft("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 1);
    ...
    void perft_bugfinder2() {
        long result =
                Perft.runPerft("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 2);
    ...
    void perft_bugfinder3() {
        long result =
                Perft.runPerft("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 3);
    ...
    void perft_bugfinder4() {
        long result =
                Perft.runPerft("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 4);
    ...
    void perft_bugfinder5() {
        long result =
                Perft.runPerft("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 5);
